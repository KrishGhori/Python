...
# They are used to return the value of a specific property, and are typically defined 
...
# set the value through getter method.For that we need setter method which can be added by 
